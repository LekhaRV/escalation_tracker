        ...
        return (
            <div className="card-highlight">
                ...
                <div className="text-center py-8 text-slate-400">
                    ...
                    <p className="text-xs mt-1 text-slate-500">AI recommendations will appear as data accumulates</p>
                </div>
            </div>
        );
    }
                ...
                {uniqueInsights.slice(0, 4).map((insight) => {
                    ...
                    return (
                        <div
                            ...
                            className={`p-4 rounded-xl border ${colorClass} backdrop-blur-sm group transition-all hover:scale-[1.01] cursor-pointer`}
                        >
